		...
		<view class="paypwd-box">
			<view class="account-form">
				<u-form ref="withdrawForm" :model="modify" :error-type="['toast']" label-position="top">
					<u-form-item :label="$t('form.old.password')" prop="ypwd" :required="true">
						<u-input v-model="modify.ypwd" type="password" :placeholder="$t('form.old.password')"></u-input>
					</u-form-item>
					<u-form-item :label="$t('form.new.password')" prop="pwd" :required="true">
						<u-input v-model="modify.pwd" type="password" :placeholder="$t('form.new.password')"></u-input>
					</u-form-item>
					<u-form-item :label="$t('form.reconfirm')" prop="cpwd" :required="true">
						<u-input v-model="modify.cpwd" type="password" :placeholder="$t('form.reconfirm')"></u-input>
					</u-form-item>
				</u-form>
				<view class="btn-box">
...
<script>
	...
	export default {
		...
		onLoad() {
			...
			// this.phoneStr = this.userInfo.tel_str
		},
		...
		methods: {
			...
			submitWithdrawForm() {
				let params = {
					ypwd: this.modify.ypwd,
					pwd: this.modify.pwd,
					cpwd: this.modify.cpwd
				}
				this.$util.postRequest(this.$api.user.modify_pwd, params, true,
					res => {
						this.$util.showNoIconToast(res.info)
						setTimeout(() => {
							uni.navigateBack({
