									...
									<u-form ref="loginForm" label-position="top" :model="login" :error-type="['toast']">
										<u-form-item :label="$t('form.phone')" :label-style="labelStyle" :left-icon-style="iconStyle" prop="tel">
											<view class="phone-input-box">
												...
												<u-input v-model="login.tel" type="number" :placeholder="$t('form.phone')"></u-input>
											</view>
										</u-form-item>
										<u-form-item :label="$t('form.password')" :label-style="labelStyle" :left-icon-style="iconStyle" prop="code">
											<view class="icon-box">
												<u-icon custom-prefix="zx-icon" name="password" size="32" color="#999">
												</u-icon>
											</view>
											<u-input v-model="login.pwd" type="password" :placeholder="$t('form.password')"></u-input>
										</u-form-item>
									</u-form>
									<view class="btn-box">
										<button @click="$u.debounce(submitLoginForm, 400, true)" :style="indexConfig ? indexConfig.btnStyle.primary : ''" class="login-btn">{{ $t('login.title') }}</button>
