...
__DEFINE__(1590472184507, function(require, module, exports) {
...
var ParseAddress = function () {
  ...
  _createClass(ParseAddress, [{
    ...
    value: function replace() {
      ...
      this.address = this.address.replace(this.address.replace(new RegExp("[^%&',;=？?$\x22]+", 'g'), ''), ' ')
    }
...
function getTargetAreaListByCode(target, code, parent) {
  ...
  var result = [];
  var list = _area3.default.all_list
  result = list[code]
  let temp = []
...
}, function(modId) { var map = {"../area":1590472184508}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1590472184510, function(require, module, exports) {
...
}, function(modId) { var map = {"../area":1590472184508,"./utils":1590472184509}; return __REQUIRE__(map[modId], modId); })
return __REQUIRE__(1590472184507);
})()
